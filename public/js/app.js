...
var GlobalStore = function () {
	...
	(0, _createClass3.default)(GlobalStore, [{
		key: 'on',
...
var _isIterable2 = __webpack_require__(200);
...
module.exports = !__webpack_require__(23) && !__webpack_require__(57)(function () {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(137), __webpack_require__(460)(module)))
...
var _classes = __webpack_require__(197);

var _globalStore = __webpack_require__(55);

var _globalStore2 = _interopRequireDefault(_globalStore);

var _rootComponent = __webpack_require__(195);

var _rootComponent2 = _interopRequireDefault(_rootComponent);

var _shareComponent = __webpack_require__(196);

var _shareComponent2 = _interopRequireDefault(_shareComponent);

var _resizeComponent = __webpack_require__(194);
...
var App = function () {
	function App() {
		...
		console.log(' VERSION ', "0.0.1"); // @preserve eslint-disable-line no-console
		console.log(' PRODUCTION ', 0); // @preserve eslint-disable-line no-console
		console.log(' TIMESTAMP ', "2018-03-05T20:52:35.259Z"); // @preserve eslint-disable-line no-console
		console.log('\n\n\n'); // @preserve eslint-disable-line no-console

		new _resizeComponent2.default({});

		console.log('window.location.pathname: ', window.location.pathname);

		if (window.location.pathname !== '/share.html') {
			new _rootComponent2.default({
				callback: this.start.bind(this)
			});
		} else {
			new _shareComponent2.default({
				callback: this.start.bind(this)
			});
		}
		...
		value: function start() {
			setTimeout(function () {
				...
				for (var c = 0; c < cw.length; c++) {
					cw[c].classList.remove(_classes.HIDE);
				}
				_globalStore2.default.set('forceResize', _globalStore2.default.get('forceResize') + 1);
			}, 150);
...
var _webpackZepto = __webpack_require__(459);

var _webpackZepto2 = _interopRequireDefault(_webpackZepto);

var _baseComponent = __webpack_require__(89);
...
var ResizeComponent = function (_BaseComponent) {
	(0, _inherits3.default)(ResizeComponent, _BaseComponent);

	function ResizeComponent(obj) {
		(0, _classCallCheck3.default)(this, ResizeComponent);

		var _this = (0, _possibleConstructorReturn3.default)(this, (ResizeComponent.__proto__ || (0, _getPrototypeOf2.default)(ResizeComponent)).call(this, obj));

		_globalStore2.default.set('viewport', {
			width: _this.getWidth(),
			height: _this.getHeight(),
			docHeight: _this.getDocHeight(),
			scrollHeight: _this.getScrollHeight()
		}, true);

		_globalStore2.default.on('change:forceResize', _this.update.bind(_this));
		return _this;
	}

	(0, _createClass3.default)(ResizeComponent, [{
		key: 'bindEvents',
		value: function bindEvents() {
		...
		value: function bindWindowEvents() {
			...
			(0, _webpackZepto2.default)(window).on('resize', function (e) {
				_this2.update();
			});
		}
	}]);
...
var RootComponent = function (_BaseComponent) {
	(0, _inherits3.default)(RootComponent, _BaseComponent);

	function RootComponent(obj) {
		(0, _classCallCheck3.default)(this, RootComponent);

		var _this = (0, _possibleConstructorReturn3.default)(this, (RootComponent.__proto__ || (0, _getPrototypeOf2.default)(RootComponent)).call(this, obj));

		_this.el = document.querySelector('#root');
		console.log(_this.el.parentNode, _this.el);
		_this.elParentWrapper = _this.el.parentNode;

		_this.currentState = 'root';
		_globalStore2.default.set('currentState', _this.currentState);
	...
	(0, _createClass3.default)(RootComponent, [{
		key: 'constructRoot',
		value: function constructRoot() {
			this.children.set('root', new _rootView2.default({
				UUID: 'root'
			}));
		}
	}, {
		...
		key: 'bindEvents',
		value: function bindEvents() {
			_globalStore2.default.on('change:scroll', this.scrollUpdate.bind(this));
			_globalStore2.default.on('change:viewport', this.viewportUpdate.bind(this));
		...
		key: 'viewportUpdate',
		value: function viewportUpdate(e) {
			// console.log(' new viewport ', e);
			var newParentHeight = e.height * .6;
			var padding = 25;
			var elHeight = (this.el.innerHeight ? this.el.offsetHeight : this.el.clientHeight) + padding;
			this.elParentWrapper.style.height = (newParentHeight >= elHeight ? newParentHeight : elHeight) + 'px';
		}
	}]);
	return RootComponent;
}(_baseComponent2.default); // import $ from 'webpack-zepto';
...
var _shareView = __webpack_require__(199);
...
var ShareComponent = function (_BaseComponent) {
	(0, _inherits3.default)(ShareComponent, _BaseComponent);

	function ShareComponent(obj) {
		(0, _classCallCheck3.default)(this, ShareComponent);

		var _this = (0, _possibleConstructorReturn3.default)(this, (ShareComponent.__proto__ || (0, _getPrototypeOf2.default)(ShareComponent)).call(this, obj));

		_this.el = document.querySelector('#root');
		console.log(_this.el.parentNode, _this.el);
		_this.elParentWrapper = _this.el.parentNode;

		_this.currentState = 'share';
		_globalStore2.default.set('currentState', _this.currentState);
		// GlobalStore.set('forceResize', 1);
	...
	(0, _createClass3.default)(ShareComponent, [{
		key: 'constructRoot',
		value: function constructRoot() {
			this.children.set('share', new _shareView2.default({
				UUID: 'share'
			}));
		}
	}, {
...
var RootView = function () {
	function RootView(obj) {
		(0, _classCallCheck3.default)(this, RootView);

		this._data = obj;
	}

	(0, _createClass3.default)(RootView, [{
		key: 'render',
		value: function render(_el) {
			this._data.copy = _config2.default.root;
			this.el = this.createRootFromTemplate((0, _root2.default)(this._data));
		...
		key: 'createRootFromTemplate',
		value: function createRootFromTemplate(template) {
			var d = document.createElement('div');
			d.innerHTML = template;
			return d.firstChild;
		}
	}, {
		key: 'defineDOMElements',
		value: function defineDOMElements() {
		...
		value: function bindEvents() {
			_globalStore2.default.on('change:scroll', this.scrollUpdate.bind(this));
			_globalStore2.default.on('change:viewport', this.onResize.bind(this));
		...
		key: 'sanitizeInput',
		value: function sanitizeInput(e) {
...
var _share = __webpack_require__(458);
...
var RootView = function () {
	...
	(0, _createClass3.default)(RootView, [{
		key: 'render',
		value: function render(_el) {
			this._data.copy = _config2.default.share;
			this.el = this.createRootFromTemplate((0, _share2.default)(this._data));
...
var setToStringTag = __webpack_require__(70);
var dP = __webpack_require__(26).f;
var each = __webpack_require__(219)(0);
var DESCRIPTORS = __webpack_require__(23);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(56)(Function.call, __webpack_require__(148).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
        buggy = !(test instanceof Array);
      } catch (e) { buggy = true; }
      return function setPrototypeOf(O, proto) {
...
var $export = __webpack_require__(0);
var $re = __webpack_require__(261)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(13)(proto, TO_PRIMITIVE, __webpack_require__(256));
...
var $export = __webpack_require__(0);
var invoke = __webpack_require__(78);
var partial = __webpack_require__(259);
